...
if not we_sudo(msg)  then return "📛*￤* هذا الاوامر للمطور الاساسي فقط 🛠" end
local num_update = https.request('https://api.TH3LEDR.com/version/') -- تحقق من التحديث اذا كان موجود او لا
if num_update > update then
sendMsg(msg.to.id,msg.id_,'🔛*¦* يوجد تحديث جديد الان \n📡*¦* جاري تنزيل وتثبيت التحديث  ...','md')
download_file('https://raw.githubusercontent.com/TH3LEDR/ZAIN.JOKER/master/inc/BOT.lua','./inc/BOT.lua')
download_file('https://raw.githubusercontent.com/TH3LEDR/ZAIN.JOKER/master/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/TH3LEDR/ZAIN.JOKER/master/inc/locks.lua','./inc/locks.lua')
download_file('https://raw.githubusercontent.com/TH3LER/ZAIN.JOKER/master/plugins/cmd_help.lua','./plugins/cmd_help.lua')
download_file('https://raw.githubusercontent.com/TH3LEDR/ZAIN.JOER/master/plugins/plug_manager.lua','./plugins/plug_manager.lua')
download_file('https://raw.githubusercontent.com/TH3LEDR/ZAIN.JOKER/master/plugins/proc_msgs.lua','./plugins/proc_msgs.lua')
download_file('https://raw.githubusercontent.com/TH3LER/ZAIN.JOKER/master/plugins/rdod_bot.lua','./plugins/rdod_bot.lua')
download_file('https://raw.githubusercontent.com/TH3LEDR/ZAIN.JOKER/master/plugins/super_group.lua','./plugins/super_group.lua')
