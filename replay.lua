...
if string.match(ww, 'زين')  or  string.match(ww, 'زيوني') or  string.match(ww, 'زيونيي') or  string.match(ww, 'زينو')  or string.match(ww, 'زين') then
return true
else
return false
end
...
if sudoname(ww) then
return"اموت علية زيون🎵ـ™ هذا العشق😻💋"
else
